...
class usuariosForm(forms.ModelForm):
  ...
  Usu_Django       = forms.CharField(max_length=50,                           label='Nombre de Usuario',required=True ,validators=[RegexValidator(r'^[a-zA-Z0-9]*$','Solo se permiten letras en este campo.'),], error_messages={'required': 'Este campo es requerido'})
